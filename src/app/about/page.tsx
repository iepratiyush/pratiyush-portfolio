              ...
              <div className="grid grid-cols-2 gap-3 md:flex md:flex-wrap">
                {aboutData.socialLinks.map((link) => (
                  <a
                    ...
                    className="flex items-center justify-center gap-2 rounded border border-border bg-card-bg px-4 py-2 text-sm font-medium text-foreground transition-colors hover:bg-secondary"
                    title={link.name}
                  >
                    {link.icon === 'github' && (
